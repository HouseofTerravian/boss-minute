...
// Perf: minimal imports, no external scripts in preview, constants hoisted
...
export default function BossMinuteOnePager() {
  ...
  // Locale autodetect (swap to geo‑IP in prod)
  useEffect(() => {
    try {
  ...
  return (
    <main className="min-h-screen w-full bg-black text-white">
      {/* Currency toggle (custom, no clipping) */}
      ...
      <section className="flex min-h-screen items-center justify-center px-6">
        <div className="mx-auto w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-8 text-center shadow-2xl">
          ...
          <div className="mx-auto mt-4 flex items-center justify-center gap-3 text-xs text-white/60">
            <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">ELITE — Coming Soon</span>
