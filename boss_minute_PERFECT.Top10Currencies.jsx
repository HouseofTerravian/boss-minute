    ...
    <main className="min-h-screen w-full bg-black text-white">
      ...
      <section className="flex min-h-screen items-center justify-center px-6">
        <div className="mx-auto w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-8 text-center shadow-2xl">
          ...
          <p className="mt-6 text-xs text-white/50">Currency auto‑detect uses browser locale. (Prod: geo‑IP + live FX. Currencies available: USD, EUR, JPY, GBP, AUD, CAD, CHF, NZD, SEK, NOK.)</p>
        </div>
      </section>
