    ...
    <main className="min-h-screen w-full bg-black text-white">
      ...
      <footer className="border-t border-white/10 bg-black py-8">
        ...
        <p className="mt-2 text-center text-xs text-white/60">
          The Boss Minute is an educational and professional development service designed for leaders and organizations. It is not therapy, counseling, medical treatment, or a substitute for licensed mental health care. If you are seeking clinical services, please contact a licensed provider in your jurisdiction.
        </p>
      </footer>
